...
INSERT INTO `goods` (`id`, `num`, `name`, `price`, `spec`, `quota`, `img`, `intro`, `mid`, `big`, `sh`) VALUES
(1, '010203', '手工訂製長夾', 1200, '全牛皮', 5, '0403.jpg', '         手工製作長夾卡片層6*2 鈔票層 *2 零錢拉鍊層 *1 \r\n採用愛馬仕相同的雙針縫法,皮件堅固耐用不脫線 \r\n材質:直革鞣(馬鞍皮)牛皮製作  \r\n手工染色 ', 5, 1, 1),
(2, '020705', '兩用式磁扣腰包', 685, '中型', 18, '0405.jpg', '材質:進口牛皮\r\n顏色:黑色荔枝紋+黑色珠光面皮(黑色縫線)\r\n尺寸:15cm*14cm(高)*6cm(前後)\r\n產地:臺灣\r\n', 5, 1, 1),
(3, '020706', '超薄設計男士長款真皮', 800, 'L號', 61, '0404.jpg', ' 基本:編織皮革對摺長款零錢包\r\n特色:最潮流最時尚的單品 \r\n顏色:黑色珠光面皮(黑色縫線)\r\n形狀:黑白格編織皮革對摺 ', 5, 1, 1),
(4, '030103', '經典牛皮少女帆船鞋', 1000, 'S號', 6, '0406.jpg', '以傳統學院派風格聞名，創始近百年工藝製鞋精神\r\n共用獨家專利氣墊技術，兼具紐約工藝精神，與舒適跑格靈魂', 7, 2, 1),
(5, '030203', '經典優雅時尚流行涼鞋', 2650, 'LL', 8, '0407.jpg', '優雅流線方型楦頭設計，結合簡潔線條綴飾，\r\n獨特的弧度與曲線美，突顯年輕優雅品味，\r\n是年輕上班族不可或缺的鞋款！\r\n全新美國運回，現貨附鞋盒', 8, 2, 1),
(6, '040202', '寵愛天然藍寶女戒', 28000, '1克拉', 1, '0408.jpg', '◎典雅設計品味款\r\n◎藍寶為珍貴天然寶石之一，具有保值收藏\r\n◎專人設計製造，以貴重珠寶精緻鑲工製造', 10, 3, 1),
...
CREATE TABLE `mem` (
  ...
  `regdate` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, '123', 'dsadsa', 'sadsa', '456', '987', '789', '2021-01-18'),
(3, 'dsad', 'sadsad', 'sadsa', 'dsad', 'sadsad', 'sadsa', '2021-01-18'),
(4, 'adasd', 'add', '1234', 'dasdsad', 'adasd', 'dadad', '2021-01-22');
...
(2, 'adasd', 'adssadsad', 29200, '', '2021-01-29', 'sadsad', 'sadsadsadsa', 'sadsadsa', 'a:2:{i:1;s:1:\"1\";i:6;s:1:\"1\";}'),
(3, 'adasd', '123', 2000, '020706', '2021-01-29', '123', '123', '123', 'a:2:{i:1;s:1:\"1\";i:3;s:1:\"1\";}'),
(4, 'add', '978456', 3335, '20210129226769', '2021-01-29', 'adasd', 'dadad', 'dasdsad', 'a:2:{i:2;s:1:\"1\";i:5;s:1:\"1\";}');
